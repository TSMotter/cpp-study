...
int main(int argc, char **argv)
{
  ...
  /*
    ...
    This will take pointer ptr and cast it to a pointer of type Type* in runtime
    It's useful in polymorphic classes
    This can go 1 of 2 ways:
      1) base class to derived class
      2) derived class to base class
  */
  try
  {
    // throw std::bad_cast();
